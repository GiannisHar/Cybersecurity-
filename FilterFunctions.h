...
DWORD gSsn_Filter_LoadImage;
DWORD gSsn_Filter_AllocateData;
DWORD gSsn_Filter_ApplyEffect;
DWORD gSsn_Filter_StartJob;
DWORD gSsn_Filter_WaitJob;
DWORD gSsn_Filter_FreeData;
DWORD gSsn_Filter_CloseJob;

DWORD gSsn_Filter_ResumeJob;
DWORD gSsn_Filter_OpenWorker;
DWORD gSsn_Filter_QueueTask;
DWORD gSsn_Filter_GetInfo;
DWORD gSsn_Filter_GetSystemState;
#pragma endregion


/*=======> GLOBAL VARIABLES V2 <=======*/
#pragma region INDIRECT SYSCALLS

typedef unsigned __int64 QWORD; 

QWORD gStub_Filter_LoadImage;
QWORD gStub_Filter_AllocateData;
QWORD gStub_Filter_ApplyEffect;
QWORD gStub_Filter_StartJob;
QWORD gStub_Filter_WaitJob;
QWORD gStub_Filter_FreeData;
QWORD gStub_Filter_CloseJob;

QWORD gStub_Filter_ResumeJob;
QWORD gStub_Filter_OpenWorker;
QWORD gStub_Filter_QueueTask;
QWORD gStub_Filter_GetInfo;
QWORD gStub_Filter_GetSystemState;
#pragma endregion
...
/*=========> FUCNTION PROTOTYPES <=========*/
#pragma region FUCNTION_PROTOTYPES
extern NTSTATUS Filter_LoadImage(
...
extern NTSTATUS Filter_AllocateData(
...
extern NTSTATUS Filter_ApplyEffect(
    _In_ HANDLE ProcessHandle,
...
extern NTSTATUS Filter_StartJob(
...
extern long Filter_WaitJob(
    _In_ HANDLE Handle,
    _In_ BOOLEAN Alertable,
    _In_opt_ PLARGE_INTEGER Timeout
);

extern NTSTATUS Filter_FreeData(
    _In_ HANDLE ProcessHandle,
    _Inout_ PVOID* BaseAddress,
    _Inout_ PSIZE_T RegionSize,
    _In_ ULONG FreeType
...
extern long Filter_CloseJob(
    _In_ _Post_ptr_invalid_ HANDLE Handle
);

extern NTSTATUS Filter_ResumeJob(
    _In_ HANDLE ThreadHandle,
    _Out_opt_ PULONG PreviousSuspendCount
);

extern NTSTATUS Filter_OpenWorker(
    _Out_ PHANDLE ThreadHandle,
    _In_ ACCESS_MASK DesiredAccess,
    _In_ POBJECT_ATTRIBUTES ObjectAttributes,
    _In_opt_ PCLIENT_ID ClientId
...
extern NTSTATUS Filter_QueueTask(
    _In_ HANDLE ThreadHandle,
...
extern NTSTATUS Filter_GetInfo(
    _In_ HANDLE ProcessHandle,
...
extern NTSTATUS Filter_GetSystemState(
